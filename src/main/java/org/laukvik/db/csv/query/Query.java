...
public class Query {
    ...
    public class Column {
        ...
        Where where;
        org.laukvik.db.ddl.Column col;
        RowMatcher matcher;

        public Column(org.laukvik.db.ddl.Column col) {
            this.col = col;
        }
        ...
        public Where is(String value) {
            matcher = new StringIsMatcher((VarCharColumn) col, value);
            return where;
        }
...
//            }
        ...
        public Where in(String... selection) {
            matcher = new StringIsMatcher((VarCharColumn) col, selection);
            return where;
        }
    ...
    public class Where {
        ...
        public Column column(org.laukvik.db.ddl.Column col) {
    ...
    public class OrderBy {
        ...
        public OrderBy asc(org.laukvik.db.ddl.Column column) {
            sortOrders.add(new SortOrder(column, SortOrder.ASC));
            return this;
        }

        public OrderBy desc(org.laukvik.db.ddl.Column column) {
    ...
    public class Select {
        ...
        private Where where;
        private final org.laukvik.db.ddl.Column[] columns;

        public Select(org.laukvik.db.ddl.Column... columns) {
