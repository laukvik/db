...
import org.laukvik.db.csv.CSVTest;
...
//        }
    ...
    public void sortDesc() throws ParseException {
        VarCharColumn president = (VarCharColumn) csv.getMetaData().getColumn("President");
...
//            System.out.println(r.getValue("Took office") + " " + r.getAsString("President"));
    ...
    public void usingWhere() throws ParseException {
        VarCharColumn homeState = (VarCharColumn) csv.getMetaData().getColumn("Home State");
        VarCharColumn president = (VarCharColumn) csv.getMetaData().getColumn("President");
